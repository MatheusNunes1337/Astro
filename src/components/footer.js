...
export default function Footer() {
  ...
  return (
    <footer>
    	...
    	<p className="icon-attribution">Icons made by <a href="https://www.flaticon.com/authors/monkik" rel="noopener noreferrer" target="_blank">monkik</a>
        from <a href="https://www.flaticon.com" rel="noopener noreferrer" target="_blank">flaticon.com</a>
        </p>
